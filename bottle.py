...
class JSONPlugin(object):
    ...
    def setup(self, app):
        app.config.define('json.enable', default=True, validate=bool,
                          help="Enable or disable automatic dict->json filter.")
        app.config.define('json.ascii', default=False, validate=bool,
                          help="Use only 7-bit ASCII characters in output.")
        app.config.define('json.indent', default=True, validate=bool,
                          help="Add whitespace to make json more readable.")
        app.config.define('json.dump_func', default=None,
